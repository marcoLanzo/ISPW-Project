...
public class Annuncio_locatore {
    ...
    public void initialize() {
        ...
        textUtente.setText("Benvenuto " + ub.getUserid());
        ...
        if (MainController.checkannounceowner(annuncioBean.getAnnounceId(), ub.getUserid()))  // Inserimento tra i preferiti
            ...
            @FXML
            public void rimuoviAnnuncio() throws SQLException {


                Alert alert = new Alert(Alert.AlertType.CONFIRMATION, "Delete " + "selection" + " ?", ButtonType.YES, ButtonType.NO);
                alert.showAndWait();

                if (alert.getResult() == ButtonType.YES) {
                    ControllerAnnuncio.getInstance().disattivaAnnuncio(annuncioBean);
                }
            }

            void iniziaPrenotazione(int announceId, Date d1 , Date d2 , String nickname){

                /*  Qui setto il calendario a rosso nelle date occupate qui indicate */
            }
