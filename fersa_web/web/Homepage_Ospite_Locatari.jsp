...
<%!  ArrayList<AnnuncioBean> ab  = annuncioBean.getTenantAnnounces();%>

<% for(int x=0; x< ab.size(); x++){
	if (request.getParameter("visualizza" + x) != null){%>

<% AnnuncioBean annuncioSelezionato = annuncioBean.getSelectedAnnounceTenant(ab.get(x));
	...
	int prezzoMin = annuncioSelezionato.getPrezzoMin();
	int prezzoMax = annuncioSelezionato.getPrezzoMax();
	...
	session.setAttribute("minPrice", prezzoMin);
	session.setAttribute("maxPrice", prezzoMax);
...
<jsp:forward page="Annuncio_Locatario_Ospite.jsp" ></jsp:forward>
...
<div class="container">
	...
	<form action="Homepage_Ospite_Locatari.jsp" name="myform" method="POST">
						...
						<div class="col-md-12">
							<div class="list-group my-3">
								<a href="#" class="list-group-item list-group-item-action d-flex   align-items-center">
									...
									<img src="res/stanza2.jpg" width="200" height="100" > </a>
							</div>
						</div>
					</div>
				</div>
