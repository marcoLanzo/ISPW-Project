...
<jsp:forward page="Annuncio_Locatore.jsp" ></jsp:forward>
...
<div class="container">
	...
	<form action="Homepage_Utente_Locatori.jsp" name="myform" method="POST">
						...
						<div class="col-md-12">
							<div class="list-group my-3">
								<a href="#" class="list-group-item list-group-item-action d-flex   align-items-center">
									...
									<img src="res/stanza1.jpg" width="150" height="100" > </a>
							</div>
						</div>
					</div>
				</div>
